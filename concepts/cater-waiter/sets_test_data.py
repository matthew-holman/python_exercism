...
recipes_without_duplicates = [
    ...
    (
        "waakye",
        "Waakye",
        {"salt", "coconut oil", "water", "white rice", "sorghum stems", "black-eyed peas", "baking soda"},
    ),
    (
    ...
    (
        ...
        "Avocado Deviled Eggs",
        {"salt", "eggs", "garlic powder", "seranno chili", "avocado", "lime juice", "pepitas", "fresh cilantro leaves"},
    ),
    (
...
all_drinks = [
    ...
    (
        "Mai Tai",
        ["cherries", "lime juice", "lime wedge", "mint leaves", "orange curacao", "orgeat syrup", "rum", "sugar syrup"],
    ),
    ...
    (
        ...
        ["fresh lime juice", "mango juice", "mint sprigs", "pineapple juice", "pomegranate juice", "tonic water"],
    ),
    ("Penicillin", ["ginger", "honey simple syrup", "lemon juice", "scotch"]),
    (
        "Pina Colada",
        ["cherries", "coconut milk", "cream of coconut", "dark rum", "fresh pineapple", "lime juice", "white rum"],
    ),
    ...
    (
        "Shirley Tonic",
        ["cinnamon sticks", "club soda", "ginger", "lemon twists", "pomegranate juice", "sugar", "whole cloves"],
    ),
