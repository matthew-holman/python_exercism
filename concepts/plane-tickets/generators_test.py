...
class PlaneTicketsTest(unittest.TestCase):
    ...
    def test_generate_seat_letters(self):
        test_data = [1, 2, 3, 4, 5]
        result_data = [["A"], ["A", "B"], ["A", "B", "C"], ["A", "B", "C", "D"], ["A", "B", "C", "D", "A"]]
    ...
    def test_assign_seats(self):
        ...
        result_data = [
            {"Passenger1": "1A", "Passenger2": "1B", "Passenger3": "1C", "Passenger4": "1D", "Passenger5": "2A"},
            {
                "TicketNo=5644": "1A",
                "TicketNo=2273": "1B",
                "TicketNo=493": "1C",
    ...
    def test_generate_codes(self):
        test_data = [(["12A", "38B", "69C", "102B"], "KL1022"), (["22C", "88B", "33A", "44B"], "DL1002")]
        result_data = [
        ...
        for variant, ((seat_numbers, flight_id), expected) in enumerate(zip(test_data, result_data), start=1):
            with self.subTest(
                f"variation #{variant}", seat_numbbers=seat_numbers, flight_id=flight_id, expected=expected
            ):
